...
/usr/bin/python2.7 daggen_s2stg.py -w workflows/InOutBndShpmtItm/ -s s3://${INFRABUCKET}/airflow/revlogistics/${ENV}/var/s2stg_workflows/ -o EDF -d generated_dags -p wf_
if [ $? -eq 0 ]; then
