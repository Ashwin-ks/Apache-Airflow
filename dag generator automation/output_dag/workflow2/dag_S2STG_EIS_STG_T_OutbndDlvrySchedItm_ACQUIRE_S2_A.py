...
dag = DAG(
    'S2STG_EIS_STG_T_OutbndDlvrySchedItm_ACQUIRE_S2_A', default_args=default_args, schedule_interval=schedule_interval,
...
task_1_session2_OutbndDlvrySchedItm_py = BashOperator(
    ...
    bash_command='python2.7 /opt/airflow/scripts/S2STG/OutbndDlvrySchedItm_PRA/1_session2_OutbndDlvrySchedItm.py',
    dag=dag
)
...
trigger = TriggerDagRunOperator(task_id='trigger_dagrun',
                                 trigger_dag_id="S2STG_EIS_STG_T_OutbndDlvrySchedItm_ACQUIRE_S3_A",
