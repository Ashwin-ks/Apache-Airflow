...
trigger = TriggerDagRunOperator(task_id='trigger_dagrun',
                                 trigger_dag_id="S2STG_EIS_STG_T_OutBndDlvryHdr_PRD_S2_D_D",
...
trigger = TriggerDagRunOperator(task_id='trigger_dagrun',
                                 trigger_dag_id="S2STG_EIS_STG_T_OutBndDlvryHdr_PRD_S2_A_D",
                                 python_callable=conditionally_trigger,
                                 params={
                                        'dependant_task_name':'task_1_select_snowflake_OutBndDlvryHdr_PRD_sql' and  'task_3_session1_OutBndDlvryHdr_PRD_py' and  'task_2_select_snowflake_OutBndDlvryHdr_PRD_sql' and  'task_5_DeleteSRC_s_m_OutBndDlvryHdr_00_ACQUIRE_PRD_sql' and  'task_4_copy_to_snowflake_OutBndDlvryHdr_PRD_sql'},
                                 dag=dag)
...
trigger = TriggerDagRunOperator(task_id='trigger_dagrun',
                                 trigger_dag_id="S2STG_EIS_STG_T_OutBndDlvryHdr_PRD_S2_E_D",
                                 python_callable=conditionally_trigger,
                                 params={
                                        'dependant_task_name':'task_1_select_snowflake_OutBndDlvryHdr_PRD_sql' and  'task_3_session1_OutBndDlvryHdr_PRD_py' and  'task_2_select_snowflake_OutBndDlvryHdr_PRD_sql' and  'task_5_DeleteSRC_s_m_OutBndDlvryHdr_00_ACQUIRE_PRD_sql' and  'task_4_copy_to_snowflake_OutBndDlvryHdr_PRD_sql'},
                                 dag=dag)
...
task_5_DeleteSRC_s_m_OutBndDlvryHdr_00_ACQUIRE_PRD_sql.set_downstream(trigger)