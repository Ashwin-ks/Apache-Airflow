...
check_prev_dag_state.set_downstream(task_1_session2_OutBndDlvryHdr_PRD_py)
...
task_4_s_m_OutBndDlvryHdr_00_ACQUIRE_PRD_sql.set_downstream(trigger1)
task_4_s_m_OutBndDlvryHdr_00_ACQUIRE_PRD_sql.set_downstream(trigger2)
task_4_s_m_OutBndDlvryHdr_00_ACQUIRE_PRD_sql.set_downstream(trigger3)