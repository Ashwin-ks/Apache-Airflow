...
check_prev_dag_state.set_downstream(task_1_EISBatchGroup_Ins_EIS_BATCHGRPLOG_OutBndDlvryHdr_PRD_sql)
...
task_3_EISBatchGroup_Upd_ETLTableAudit_OutBndDlvryHdr_PRD_sql.set_downstream(trigger1)
task_3_EISBatchGroup_Upd_ETLTableAudit_OutBndDlvryHdr_PRD_sql.set_downstream(trigger2)
task_3_EISBatchGroup_Upd_ETLTableAudit_OutBndDlvryHdr_PRD_sql.set_downstream(trigger3)