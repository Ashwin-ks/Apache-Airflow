...
dag = DAG(
    'S2STG_EIS_STG_T_OutBndDlvryHdr_PRD_S1_TRIGGERPARAM', default_args=default_args, schedule_interval=schedule_interval,
...
task_3_session1_OutBndDlvryHdr_PRD_py = BashOperator(
    ...
    bash_command='python2.7 /home/dev//3_session1_OutBndDlvryHdr_PRD.py',
    dag=dag
)
