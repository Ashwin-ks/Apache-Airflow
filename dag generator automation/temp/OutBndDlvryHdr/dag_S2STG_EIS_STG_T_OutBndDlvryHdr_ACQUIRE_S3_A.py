...
trigger = TriggerDagRunOperator(task_id='trigger_dagrun',
                                 trigger_dag_id="EIS_T_OutbndShpmtHdr_P",
                                 python_callable=conditionally_trigger,
                                 params={
                                        'dependant_task_name':'task_1_EISBatchGroup_Ins_EIS_BATCHGRPLOG_OutbndDlvryHdr_sql' and  'task_3_EISBatchGroup_Upd_ETLTableAudit_OutbndDlvryHdr_sql' and  'task_2_EISBatchGroup_Upd_EIS_REQUEST_LOG_OutbndDlvryHdr_sql'},
                                 dag=dag)
...
task_3_EISBatchGroup_Upd_ETLTableAudit_OutbndDlvryHdr_sql.set_downstream(trigger)