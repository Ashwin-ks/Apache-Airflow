...
dag = DAG(
    'S2STG_EIS_STG_T_OutBndDlvryHdr_ACQUIRE_S2_D', default_args=default_args, schedule_interval=schedule_interval,
...
task_1_session2_OutbndDlvryHdr_py = BashOperator(
    ...
    bash_command='python2.7 /opt/airflow/scripts/S2STG/OutBndDlvryHdr_PRD/1_session2_OutbndDlvryHdr.py',
    dag=dag
)
...
task_2_copy_to_snowflake_OutbndDlvryHdr_sql = SnowFlakeOperator(
    ...
    parameters={'PARAMSRCTABLE': 'S_2LIS_12_VCHDR_D', 'TABLE_NAME_XI': 'LIKP_D_XI', 'PARAMTGTTABLE': 'LIKP_D_XI', 'SCHEMA_STG': 'EIS_STG_T', 'SRCSYS': "'R3_PRD'", 'DATABASE': 'NGP_DA_DEV', 'INTERMEDIATE_FILE_PATH': '/opt/airflow/s2stg_wrk/OutBndDlvryHdr_PRD', 'DATASRC': "'2LIS_12_VCHDR'", 'PSANAME': "'2LIS_12_VCHDR%'", 'BATCH_GROUP': 'USA', 'ORACLE_EXPORT_SQL': 'oracle_output1.sql', 'TRIGGER': 'S2STG_EIS_STG_T_OutbndDlvryHdr_ACQUIRE_S3_D', 'TABLE_NAME': 'OutbndDlvryHdr_PRD', 'SCHEMA_T': 'EIS_T', 'SCRIPT_PATH': '/opt/airflow/scripts/S2STG/OutBndDlvryHdr_PRD'}
)
