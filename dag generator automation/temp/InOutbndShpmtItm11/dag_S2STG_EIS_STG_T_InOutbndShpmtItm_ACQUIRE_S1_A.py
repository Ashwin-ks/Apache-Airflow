...
task_1_select_snowflake_InOutBndShpmtItm_sql = SnowFlakeOperator(
    ...
    sql="s3://edf-infrabootstrap-preprod/airflow/revlogistics/dev/var/S2STG_workflows/InOutbndShpmtItm/wf_S2STG_EIS_STG_T_InOutbndShpmtItm_ACQUIRE_S1/1_select_snowflake_InOutBndShpmtItm.sql ",
    conn_id="snowflake",
    dag=dag,
...
task_2_select_snowflake_InOutBndShpmtItm_sql = SnowFlakeOperator(
    ...
    sql="s3://edf-infrabootstrap-preprod/airflow/revlogistics/dev/var/S2STG_workflows/InOutbndShpmtItm/wf_S2STG_EIS_STG_T_InOutbndShpmtItm_ACQUIRE_S1/2_select_snowflake_InOutBndShpmtItm.sql ",
    conn_id="snowflake",
    dag=dag,
    on_failure_callback=None,
    parameters={'PARAMSRCTABLE': 'S_2LIS_08TRTLP_A', 'TABLE_NAME_XI': 'VTTP_A_xi', 'PARAMTGTTABLE': 'VTTP_A_xi', 'SCHEMA_STG': 'EIS_STG_T', 'SRCSYS': "'R3_PRA'", 'DATABASE': 'NGP_DA_DEV', 'INTERMEDIATE_FILE_PATH': '/opt/airflow/s2stg_wrk/InOutBndShpmtItm_PRA', 'DATASRC': "'2LIS_08TRTLP'", 'PSANAME': "'2LIS_08TRTLP%'", 'BATCH_GROUP': 'USA', 'TABLE_NAME': 'InOutBndShpmtItm_PRA', 'SCHEMA_T': 'EIS_T', 'SCRIPT_PATH': '/opt/airflow/scripts/S2STG/InOutBndShpmtItm_PRA'}
...
task_3_session1_InOutBndShpmtItm_py = BashOperator(
    ...
    bash_command='python2.7 /opt/airflow/scripts/S2STG/InOutBndShpmtItm_PRA/3_session1_InOutBndShpmtItm.py',
    dag=dag
)
...
task_4_copy_to_snowflake_InOutBndShpmtItm_sql = SnowFlakeOperator(
    ...
    sql="s3://edf-infrabootstrap-preprod/airflow/revlogistics/dev/var/S2STG_workflows/InOutbndShpmtItm/wf_S2STG_EIS_STG_T_InOutbndShpmtItm_ACQUIRE_S1/4_copy_to_snowflake_InOutBndShpmtItm.sql ",
    conn_id="snowflake",
    dag=dag,
    on_failure_callback=None,
    parameters={'PARAMSRCTABLE': 'S_2LIS_08TRTLP_A', 'TABLE_NAME_XI': 'VTTP_A_xi', 'PARAMTGTTABLE': 'VTTP_A_xi', 'SCHEMA_STG': 'EIS_STG_T', 'SRCSYS': "'R3_PRA'", 'DATABASE': 'NGP_DA_DEV', 'INTERMEDIATE_FILE_PATH': '/opt/airflow/s2stg_wrk/InOutBndShpmtItm_PRA', 'DATASRC': "'2LIS_08TRTLP'", 'PSANAME': "'2LIS_08TRTLP%'", 'BATCH_GROUP': 'USA', 'TABLE_NAME': 'InOutBndShpmtItm_PRA', 'SCHEMA_T': 'EIS_T', 'SCRIPT_PATH': '/opt/airflow/scripts/S2STG/InOutBndShpmtItm_PRA'}
...
task_5_DeleteSRC_s_m_InOutBndShpmtItm_00_ACQUIRE_sql = SnowFlakeOperator(
    ...
    sql="s3://edf-infrabootstrap-preprod/airflow/revlogistics/dev/var/S2STG_workflows/InOutbndShpmtItm/wf_S2STG_EIS_STG_T_InOutbndShpmtItm_ACQUIRE_S1/5_DeleteSRC_s_m_InOutBndShpmtItm_00_ACQUIRE.sql ",
    conn_id="snowflake",
    dag=dag,
    on_failure_callback=None,
    parameters={'PARAMSRCTABLE': 'S_2LIS_08TRTLP_A', 'TABLE_NAME_XI': 'VTTP_A_xi', 'PARAMTGTTABLE': 'VTTP_A_xi', 'SCHEMA_STG': 'EIS_STG_T', 'SRCSYS': "'R3_PRA'", 'DATABASE': 'NGP_DA_DEV', 'INTERMEDIATE_FILE_PATH': '/opt/airflow/s2stg_wrk/InOutBndShpmtItm_PRA', 'DATASRC': "'2LIS_08TRTLP'", 'PSANAME': "'2LIS_08TRTLP%'", 'BATCH_GROUP': 'USA', 'TABLE_NAME': 'InOutBndShpmtItm_PRA', 'SCHEMA_T': 'EIS_T', 'SCRIPT_PATH': '/opt/airflow/scripts/S2STG/InOutBndShpmtItm_PRA'}
...
trigger = TriggerDagRunOperator(task_id='trigger_dagrun',
                                 trigger_dag_id="S2STG_EIS_STG_T_InOutbndShpmtItm_ACQUIRE_S2_A",
