...
start_date =  datetime(2017,07,30)
task_concurrency=15
...
dag = DAG(
    'dag_schedule_test2', default_args=default_args, schedule_interval=schedule_interval,
    max_active_runs=max_simultaneous_run,
    concurrency=task_concurrency, start_date=start_date)

task_1 = BashOperator(
    task_id='task_1_test2',
    bash_command='echo "Test print1"',
    dag=dag
    )

task_2 = BashOperator(
    task_id='task_2_test2',
    bash_command='echo "Test print1"',
    dag=dag
    )
