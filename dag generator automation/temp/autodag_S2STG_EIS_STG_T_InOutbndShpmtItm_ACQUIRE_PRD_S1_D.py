...
dag = DAG(
    'autodag_S2STG_EIS_STG_T_InOutbndShpmtItm_ACQUIRE_PRD_S1_D', default_args=default_args, schedule_interval=schedule_interval,
...
task_1_select_snowflake_InOutBndShpmtItm_PRD_sql = SnowFlakeOperator(
    ...
    sql="s3://edf-infrabootstrap-preprod/airflow/revlogistics/dev/var/dags/1_select_snowflake_InOutBndShpmtItm_PRD.sql ",
    conn_id="snowflake",
    dag=dag,
...
task_2_select_snowflake_InOutBndShpmtItm_PRD_sql = SnowFlakeOperator(
    ...
    sql="s3://edf-infrabootstrap-preprod/airflow/revlogistics/dev/var/dags/2_select_snowflake_InOutBndShpmtItm_PRD.sql ",
    conn_id="snowflake",
    dag=dag,
    on_failure_callback=None,
    parameters={'PARAMSRCTABLE': 'S_2LIS_08TRTLP_D', 'TABLE_NAME_XI': 'VTTP_D_xi', 'PARAMTGTTABLE': 'VTTP_D_xi', 'SCHEMA_STG': 'EIS_STG_T', 'SRCSYS': "'R3_PRD'", 'DATABASE': 'NGP_DA_DEV', 'INTERMEDIATE_FILE_PATH': '/opt/airflow/s2stg_wrk/InOutBndShpmtItm_PRD/', 'DATASRC': "'2LIS_08TRTLP'", 'PSANAME': "'2LIS_08TRTLP%'", 'BATCH_GROUP': 'USA', 'TABLE_NAME': 'InOutBndShpmtItm_PRD', 'SCHEMA_T': 'EIS_T', 'SCRIPT_PATH': '/opt/airflow/scripts/S2STG/InOutBndShpmtItm_PRD/'}
...
task_4_copy_to_snowflake_InOutBndShpmtItm_PRD_sql = SnowFlakeOperator(
    ...
    sql="s3://edf-infrabootstrap-preprod/airflow/revlogistics/dev/var/dags/4_copy_to_snowflake_InOutBndShpmtItm_PRD.sql ",
    conn_id="snowflake",
    dag=dag,
    on_failure_callback=None,
    parameters={'PARAMSRCTABLE': 'S_2LIS_08TRTLP_D', 'TABLE_NAME_XI': 'VTTP_D_xi', 'PARAMTGTTABLE': 'VTTP_D_xi', 'SCHEMA_STG': 'EIS_STG_T', 'SRCSYS': "'R3_PRD'", 'DATABASE': 'NGP_DA_DEV', 'INTERMEDIATE_FILE_PATH': '/opt/airflow/s2stg_wrk/InOutBndShpmtItm_PRD/', 'DATASRC': "'2LIS_08TRTLP'", 'PSANAME': "'2LIS_08TRTLP%'", 'BATCH_GROUP': 'USA', 'TABLE_NAME': 'InOutBndShpmtItm_PRD', 'SCHEMA_T': 'EIS_T', 'SCRIPT_PATH': '/opt/airflow/scripts/S2STG/InOutBndShpmtItm_PRD/'}
...
task_5_DeleteSRC_s_m_InOutBndShpmtItm_00_ACQUIRE_PRD_sql = SnowFlakeOperator(
    ...
    sql="s3://edf-infrabootstrap-preprod/airflow/revlogistics/dev/var/dags/5_DeleteSRC_s_m_InOutBndShpmtItm_00_ACQUIRE_PRD.sql ",
    conn_id="snowflake",
    dag=dag,
    on_failure_callback=None,
    parameters={'PARAMSRCTABLE': 'S_2LIS_08TRTLP_D', 'TABLE_NAME_XI': 'VTTP_D_xi', 'PARAMTGTTABLE': 'VTTP_D_xi', 'SCHEMA_STG': 'EIS_STG_T', 'SRCSYS': "'R3_PRD'", 'DATABASE': 'NGP_DA_DEV', 'INTERMEDIATE_FILE_PATH': '/opt/airflow/s2stg_wrk/InOutBndShpmtItm_PRD/', 'DATASRC': "'2LIS_08TRTLP'", 'PSANAME': "'2LIS_08TRTLP%'", 'BATCH_GROUP': 'USA', 'TABLE_NAME': 'InOutBndShpmtItm_PRD', 'SCHEMA_T': 'EIS_T', 'SCRIPT_PATH': '/opt/airflow/scripts/S2STG/InOutBndShpmtItm_PRD/'}
...
trigger = TriggerDagRunOperator(task_id='trigger_dagrun',
                                 trigger_dag_id="autodag_S2STG_EIS_STG_T_InOutbndShpmtItm_ACQUIRE_PRD_S2_D",
