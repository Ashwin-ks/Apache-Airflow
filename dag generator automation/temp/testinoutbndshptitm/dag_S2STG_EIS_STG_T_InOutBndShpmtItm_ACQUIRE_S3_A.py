...
task_1_EISBatchGroup_Ins_EIS_BATCHGRPLOG_InOutBndShpmtItm_sql = SnowFlakeOperator(
    ...
    sql="s3://edf-infrabootstrap-preprod/airflow/revlogistics/lab/var/workflows/wf_S2STG_EIS_STG_T_InOutBndShpmtItm_ACQUIRE_S3/1_EISBatchGroup_Ins_EIS_BATCHGRPLOG_InOutBndShpmtItm.sql ",
    conn_id="snowflake",
    dag=dag,
...
task_2_EISBatchGroup_Upd_EIS_REQUEST_LOG_InOutBndShpmtItm_sql = SnowFlakeOperator(
    ...
    sql="s3://edf-infrabootstrap-preprod/airflow/revlogistics/lab/var/workflows/wf_S2STG_EIS_STG_T_InOutBndShpmtItm_ACQUIRE_S3/2_EISBatchGroup_Upd_EIS_REQUEST_LOG_InOutBndShpmtItm.sql ",
    conn_id="snowflake",
    dag=dag,
    on_failure_callback=None,
    parameters={'PARAMSRCTABLE': 'S_2LIS_08TRTLP_A', 'TABLE_NAME_XI': 'VTTP_A_xi', 'PARAMTGTTABLE': 'VTTP_A_xi', 'SCHEMA_STG': 'EIS_STG_T', 'SRCSYS': "'R3_PRA'", 'DATABASE': 'NGP_DA_DEV', 'INTERMEDIATE_FILE_PATH': '/opt/airflow/s2stg_wrk/InOutBndShpmtItm_PRA', 'DATASRC': "'2LIS_08TRTLP'", 'PSANAME': "'2LIS_08TRTLP%'", 'BATCH_GROUP': 'ASIA', 'TABLE_NAME': 'InOutBndShpmtItm_PRA', 'SCHEMA_T': 'EIS_T', 'SCRIPT_PATH': '/opt/airflow/S2STG/InOutBndShpmtItm_PRA'}
...
task_3_EISBatchGroup_Upd_ETLTableAudit_InOutBndShpmtItm_sql = SnowFlakeOperator(
    ...
    sql="s3://edf-infrabootstrap-preprod/airflow/revlogistics/lab/var/workflows/wf_S2STG_EIS_STG_T_InOutBndShpmtItm_ACQUIRE_S3/3_EISBatchGroup_Upd_ETLTableAudit_InOutBndShpmtItm.sql ",
    conn_id="snowflake",
    dag=dag,
    on_failure_callback=None,
    parameters={'PARAMSRCTABLE': 'S_2LIS_08TRTLP_A', 'TABLE_NAME_XI': 'VTTP_A_xi', 'PARAMTGTTABLE': 'VTTP_A_xi', 'SCHEMA_STG': 'EIS_STG_T', 'SRCSYS': "'R3_PRA'", 'DATABASE': 'NGP_DA_DEV', 'INTERMEDIATE_FILE_PATH': '/opt/airflow/s2stg_wrk/InOutBndShpmtItm_PRA', 'DATASRC': "'2LIS_08TRTLP'", 'PSANAME': "'2LIS_08TRTLP%'", 'BATCH_GROUP': 'ASIA', 'TABLE_NAME': 'InOutBndShpmtItm_PRA', 'SCHEMA_T': 'EIS_T', 'SCRIPT_PATH': '/opt/airflow/S2STG/InOutBndShpmtItm_PRA'}
