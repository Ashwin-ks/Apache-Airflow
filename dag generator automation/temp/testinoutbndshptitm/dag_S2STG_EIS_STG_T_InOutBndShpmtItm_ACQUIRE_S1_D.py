...
task_1_select_snowflake_InOutBndShpmtItm_sql = SnowFlakeOperator(
    ...
    parameters={'PARAMSRCTABLE': 'S_2LIS_08TRTLP_D', 'TABLE_NAME_XI': 'VTTP_D_xi', 'PARAMTGTTABLE': 'VTTP_D_xi', 'SRCSYS': "'R3_PRD'", 'SCHEMA_STG_T': 'EIS_STG_T', 'DATABASE': 'NGP_DA_DEV', 'INTERMEDIATE_FILE_PATH': '/opt/airflow/s2stg_wrk/InOutBndShpmtItm_PRD', 'DATASRC': "'2LIS_08TRTLP'", 'PSANAME': "'2LIS_08TRTLP%'", 'BATCH_GROUP': 'USA', 'TABLE_NAME': 'InOutBndShpmtItm_PRD', 'SCHEMA_T': 'EIS_T', 'SCRIPT_PATH': '/opt/airflow/S2STG/InOutBndShpmtItm_PRD'}
)
...
task_3_session1_InOutBndShpmtItm_py = BashOperator(
    ...
    bash_command='python2.7 /opt/airflow/S2STG/InOutBndShpmtItm_PRD/3_session1_InOutBndShpmtItm.py',
    dag=dag
)
...
trigger = TriggerDagRunOperator(task_id='trigger_dagrun',
                                 trigger_dag_id="S2STG_EIS_STG_T_InOutBndShpmtItm_ACQUIRE_S2_A_D",
